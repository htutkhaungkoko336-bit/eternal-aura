...
export function renderNotificationScreen(container) {
    container.innerHTML = `
        <div style="width: 100%; height: 100%; display: flex; flex-direction: column; justify-content: flex-start; padding: 20px; box-sizing: border-box; overflow-y: auto; background-color: #0b0f19;">                
            <!-- Header -->
