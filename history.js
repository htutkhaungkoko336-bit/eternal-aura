...
document.addEventListener("DOMContentLoaded", () => {
    // 1. Inject History Modal HTML into the body dynamically
    ...
    // 2. Inject CSS styles dynamically for a modern, beautiful look
    const historyStyles = `
        <style>
    ...
    // 3. Dummy History Data (နမူနာအနေဖြင့် ထည့်ထားသည်၊ လိုအပ်သလို API သို့မဟုတ် LocalStorage မှ ချိတ်နိုင်သည်)
    const sampleHistory = [
